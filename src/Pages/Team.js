  ...
  <div className="row center_o1">
   ...
   <div className="col-md-7">
     <div className="center_o1r text-end">
	  <h6 className="mb-0 col_red"><a href="#">Home</a> <span className="me-2 ms-2 text-light"><i className="fa fa-caret-right align-middle"></i></span> Team</h6>
	 </div>
   </div>
  </div>
 </div>
...
<section id="team" className="pt-4 pb-4 bg_grey">
 <div className="container-xl">
	  ...
	  <div className="team_1i row mt-4">
	   <div className="col-md-4">
	    <div className="team_1i1 clearfix position-relative">
		 <div className="team_1i1i clearfix">
		   <div className="grid clearfix">
